...
<html lang="es">
  <head>
    ...
    <meta name="title" content="Repuestos para Aviones" />
    <title>Repuestos de Aviones</title>
    ...
    <div id="wrap">
      ...
      <div class="container">
        ...
        <div class="page-header text-center">
            <h1>Repuestos de Aviones</h1>
        </div><!--Fin de page-header-->

        <div class="row"><!--Inicio Row1-->
          <div class="col-sm-5 col-sm-offset-2"><!--Imagen-->
            <img class="img-thumbnail" src="img/Airbus.png" alt="Aviones" title="Aviones">
          </div>

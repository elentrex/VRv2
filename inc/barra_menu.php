<!-- Fixed navbar -->
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"><!-- navbar-inverse:black || nav-fixed-top:barra fija top-->
  <div class="container">
    ...
    <div class="collapse navbar-collapse"><!--Menú-->
      ...
      <ul class="nav navbar-nav navbar-right"><!--Menu top-->
        ...
        <li><a href="tutorial.php"><span class="glyphicon glyphicon-facetime-video"></span>Tutorial</a></li>
        ...
        <li><a href="contacto.php"><span class="glyphicon glyphicon-info-sign"></span>Contacto</a></li>
        <li class="dropdown">

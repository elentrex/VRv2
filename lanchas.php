...
<html lang="es">
  <head>
    ...
    <meta name="title" content="Repuestos para Lanchas" />
    <title>Repuestos para Lanchas</title>
    ...
    <div id="wrap">
      ...
      <div class="container">
        ...
        <div class="page-header text-center">
            <h1>Repuestos de Lanchas</h1>
        </div><!--Fin de page-header-->

        <div class="row"><!--Inicio Row1-->
          <div class="col-sm-5 col-sm-offset-2"><!--Imagen-->
            <img class="img-thumbnail" src="img/lancha01.png" alt="Lancha" title="Lancha">
          </div>

...
<html lang="es">
  <head>
    ...
    <meta name="title" content="Repuestos para Maquinaria Pesada" />
    <title>Repuestos para Maquinaria Pesada</title>
      ...
      <div class="container">
        <div class="row">
          <div class="page-header text-center">
              <h1>Repuestos de Maquinaria Pesada</h1>
          </div><!--Fin de page-header-->

          <div class="row"><!--Inicio Row1-->
            <div class="col-sm-5 col-sm-offset-2"><!--Imagen-->
              <img class="img-thumbnail" src="img/Montacargas2.png" alt="Maquinaria Pesada" title="Maquinaria Pesada">
            </div>
